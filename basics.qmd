...
-   **The Console** (left), where you can directly type and run code
...
If you are brand new to R (or even if you have some experience) you should also read through these beginner resources:
...
**Spatial Data Science with applications in R by Edzer Pebesma & Roger Bivand: [R Basics](https://keen-swartz-3146c4.netlify.app/r-basics.html#r-basics).** This covers pipes (which we will use a lot in this workshop), data structure, and how to dissect the different parts and structure of spatial data in R.
